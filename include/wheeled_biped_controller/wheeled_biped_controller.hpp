...
namespace wheeled_biped_controller
{
  ...
  protected:
    ...
    std::map<std::string, std::map<std::string, std::shared_ptr<hardware_interface::LoanedCommandInterface>>>
        command_interfaces_map_;

    // Map from joint/sensor names to state types to state interfaces
    std::map<std::string, std::map<std::string, std::shared_ptr<hardware_interface::LoanedStateInterface>>>
